...
const Program = () => {
  return (
    ...
    <p className="pb-5"> - Opportunities to contribute creatively to the program </p>
    <p> And more! </p>
    <p className="flex flex-wrap pt-5 font-bold uppercase font-subtitle md:text-[20px] text-[16px]">More information coming soon</p>
        </div>
</motion.div>
