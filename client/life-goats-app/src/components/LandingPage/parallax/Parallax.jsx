...
const Parallax = () => {
  ...
  return (
    <section id="parallax" style={sectionStyle} className="bg-gradient-to-b from-background via-blue-100 to-blue-400 bg-contain lg:bg-cover bg-no-repeat bg-fixed relative w-screen h-screen pt-10 inset-0 overflow-hidden">
