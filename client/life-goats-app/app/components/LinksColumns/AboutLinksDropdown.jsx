...
const AboutLinksDropdown = ({ active, setActive, handleLinkClick, aboutLinks }) => {
      ...
      <div>
        ...
        >
          <div className="flex flex-row items-center justify-center gap-2">
            <p className={`${isHovered ? 'hovered' : ''}`}>About</p>
            <Image
...
export default AboutLinksDropdown;
